...
-(void)doneClick
{
    ...
    if ([self.delegate respondsToSelector:@selector(toobarDonBtnHaveClick:resultString:row:)]) {
        [self.delegate toobarDonBtnHaveClick:self resultString:_resultString row:rowNumber];
    }
    [self removeFromSuperview];
}
/**
