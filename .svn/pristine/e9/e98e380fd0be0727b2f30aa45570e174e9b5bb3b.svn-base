        ...
        [SMSSDK commitVerificationCode:self.verifyCodeField.text phoneNumber:_phone zone:_areaCode result:^(NSError *error) {
            ...
            if (!error) {
                ...
                UIAlertView* alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"verifycoderighttitle", nil)
                                                      ...
                                                      otherButtonTitles:nil, nil];
                if (self.passwordField.text.length>=6 && self.passwordField.text.length<12){
                ...
                _alert3 = alert;
                    ...
                    UIAlertView *alerviewpassworld = [[UIAlertView alloc]initWithTitle:@"提示" message:@"密码6到12位" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
                    [alerviewpassworld show];
                }
...
- (void)getData{
    ...
    NSString *userName = _phone;
    NSString *pss = _passwordField.text;
    //封装参数
    NSDictionary *dict = @{@"mobile" : userName,
                           @"userPass" : pss
                           };
    ...
    //拼接链接
    NSString *url = [NSString stringWithFormat:@"%@%@",kSERVER,@"la"];
    ...
    [[BM_NetAPIManager sharedManager]request_WithParamsPost:jsonDic UrlStr:url andBlock:^(id responseData, NSError *error) {
        if (responseData)
        {
            ...
            if (result == YES) {
                ...
                //保存用户名
                [self showHudTipStr:@"正在注册..."];
                
//                FourVC* yj = [[FourVC alloc] init];
...
- (void)viewDidLoad
{
    ...
    _passwordField.frame = CGRectMake(15, 169+statusBarHeight, self.view.frame.size.width - 30, 46);
    _passwordField.borderStyle = UITextBorderStyleBezel;
    _passwordField.textAlignment = NSTextAlignmentCenter;
    _passwordField.placeholder = NSLocalizedString(@"passworld", nil);
    _passwordField.font = [UIFont fontWithName:@"Helvetica" size:18];
    ...
    _timeLabel.frame = CGRectMake(15, 227+statusBarHeight, self.view.frame.size.width - 30, 40);
    ...
    _repeatSMSBtn.frame = CGRectMake(15, 227+statusBarHeight, self.view.frame.size.width - 30, 30);
    ...
    _submitBtn.frame = CGRectMake(15, 278 + statusBarHeight, self.view.frame.size.width - 30, 42);
