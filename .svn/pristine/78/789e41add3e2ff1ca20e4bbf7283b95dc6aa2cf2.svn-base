...
//    [self.view addSubview:tableView];
    ...
    areaCodeField.frame = CGRectMake(10, 55 + statusBarHeight, (self.view.frame.size.width - 30)/4, 40 + statusBarHeight/4);
    ...
    telField.frame = CGRectMake(20 + (self.view.frame.size.width - 30)/4, 55 + statusBarHeight,(self.view.frame.size.width - 30)*3/4 , 40 + statusBarHeight/4);
    ...
    nextBtn.frame = CGRectMake(10, 120 + statusBarHeight, self.view.frame.size.width - 20, 42);
